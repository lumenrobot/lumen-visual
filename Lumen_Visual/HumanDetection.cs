...
namespace Lumen_Visual
{
    class HumanDetection
    {
        ...
        {
            haarUpperBody = new HaarCascade("haarcascade_mcs_upperbody.xml");
        }
        ...
        public MCvAvgComp[] detect(Image<Bgr, byte> ImageFrame)
        {
            ...
            faces = this.haarUpperBody.Detect(grayFrame, 1.4, 4, HAAR_DETECTION_TYPE.DO_CANNY_PRUNING, new Size(25, 25), Size.Empty);
